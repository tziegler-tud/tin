...
class ProductAutomatonEdge(
    ...
    override fun toString(): String {
        val eps = "epsilon"
        val incoming: String = if(label.incoming.isEpsilonLabel()) eps else label.incoming.toString()
        val outgoing: String = if(label.outgoing.isEpsilonLabel()) eps else label.outgoing.toString()

        return "${source.identifier} - [${incoming}, ${outgoing}, ${label.cost}] -> ${target.identifier}";
