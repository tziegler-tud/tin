...
class QueryConjunctReassemblerV2() {
    ...
    fun reassemble(
        ...
        singleResultsList: Map<String, Set<ShortestPathResult<DbResultNode>>>
        ...
        singleResultsList.forEach { (identifier, answerSet) ->
            ...
            answerSet.forEach { answerTriplet ->
                prevVMCSet.forEach { vmcSet ->
                    ...
                    if (sourceVariableAssignment != null && sourceVariableAssignment != answerTriplet.source.identifier
                        || targetVariableAssignment != null && targetVariableAssignment != answerTriplet.target.identifier
                    ) {
                        ...
                        applyVariableAssignments(
                            ...
                            sourceVariableAssignment = answerTriplet.source.identifier,
                            targetVariableIsAnswerVariable = targetVariableIsAnswerVariable,
                            targetVariableName = currentTargetVariableName,
                            targetVariableAssignment = answerTriplet.target.identifier,
                            cost = answerTriplet.cost!!.toDouble()
                        ).onSuccess {
    ...
    fun reassembleThreshold(
        ...
        singleResultsList.forEach { (identifier, answerSet) ->
            ...
            currentVMCSet.removeIf { it.cost > thresholdValue }
