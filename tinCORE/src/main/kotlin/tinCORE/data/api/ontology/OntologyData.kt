package tinCORE.data.tintheweb.ontology
...
data class OntologyData @JsonCreator constructor(
    ...
    constructor(ontologyInfoData: OntologyInfoData): this(
        ...
        axboxAxioms = ontologyInfoData.aboxAxioms,
        tboxAxions = ontologyInfoData.tboxAxioms,
        signature = ontologyInfoData.signature,
    )
}
