...
class SpaS1CalculatorCompressing(
     ...
     */
    fun calculateAll(table: ELHISPALoopTableCompressing, updateTable: ELHISPALoopTableCompressing, isInitialIteration: Boolean): ELHISPALoopTableCompressing {
        ...
        val newTable = ELHISPALoopTableCompressing(ec.spaRestrictionBuilder)
...
//                                                val atomicSubsumers: HashSet<OWLClass> = hashSetOf()
                                                ...
                                                ec.forEachTailsetDescendingNumeric tailsets@{  tailset ->
...
//                                                    println("Calculating tailset " + tcCounter + "/ " + ec.tailsetSize);
                                                    ...
                                                    val entry = SPANumericLoopTableEntry(
                                                        querySource,
                                                        transducerSource,
                                                        queryTarget,
                                                        transducerTarget,
