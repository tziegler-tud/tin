...
//        val exampleFile = readWithFileReaderService("univ-bench.owl.rdf").get()
    ...
    fun loadExampleQueryUnivBench(): FileReaderResult<QueryGraph> {
        return readQueryWithFileReaderService("spaCalculation/table/univbench-test1.txt")
    }

    fun loadExampleTransUnivBench(): FileReaderResult<TransducerGraph> {
        return readTransducerWithFileReaderService("spaCalculation/table/univbench-test1.txt")
    }
    ...
    fun testLoopTableConstruction(){
        ...
        val query = loadExampleQueryUnivBench()
        val transducer = loadExampleTransUnivBench()
