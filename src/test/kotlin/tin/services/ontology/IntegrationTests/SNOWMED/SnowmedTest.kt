...
class SnowmedTest {
    ...
    fun testQueryAnswering() {
        ...
        //load ontology
        val manager = loadExampleOntology("snowmed-2024-09.owl")

        val query = readQueryWithFileReaderService("integration/SNOWMED/1.txt")
        val transducer = readTransducerWithFileReaderService("integration/SNOWMED/1.txt")
