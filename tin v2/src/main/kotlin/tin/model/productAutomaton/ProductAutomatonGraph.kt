...
class ProductAutomatonGraph {
    ...
    fun addProductAutomatonNode(productAutomatonNode: ProductAutomatonNode) {
        for (node in nodes) {
            if (node.identifier.value0.identifier.equals(productAutomatonNode.identifier.value0.identifier, ignoreCase = true) &&
                    node.identifier.value1.identifier.equals(productAutomatonNode.identifier.value1.identifier, ignoreCase = true) &&
                    node.identifier.value2.identifier.equals(productAutomatonNode.identifier.value2.identifier, ignoreCase = true)) return
        }
