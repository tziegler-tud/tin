...
import tinLIB.services.Task.AbstractTaskProcessor
...
import tinLIB.services.Task.ProcessingResultStatus

import kotlin.time.TimeSource

class DlTaskProcessor(
    override val task: Task,
    private val dlTask: DlTask,
    ...
    private val compConfig = dlTask.getComputationConfiguration();
    private val runConfig = dlTask.getRuntimeConfiguration();
    ...
    ): this(task, dlTask, manager, queryGraph, TransducerMode.provided, null, transducerGraph)



    override fun execute(): ProcessingResult<DlResultNode> {
        //execute task
