...
import queryAnswering.algorithms.DijkstraThreshold;
...
public class StatsTrackerThresholdOptimized implements StatsTracker {
    ...
    public StatsTrackerThresholdOptimized(DataProvider dataProvider, Double threshold) {
