...
@SpringBootTest
@TestConfiguration
class TransducerReaderServiceTest {
    @Autowired
    ...
    private fun constructComparisonGraph() : TransducerGraph {
        ...
        val t0 = TransducerNode("t0", true, false);
        val t1 = TransducerNode("t1", false, false);
        val t2 = TransducerNode("t2", false, true);
        ...
        comparisonGraph.addEdge(e2.source, e2.target, e2.incomingString, e2.outgoingString, e2.cost);
        comparisonGraph.addEdge(e3.source, e3.target, e3.incomingString, e3.outgoingString, e3.cost);
