...
import tin.services.ontology.loopTable.loopTableEntry.SPANumericLoopTableEntry
...
//        builder.calculateWithDepthLimit(iterationLimit);
        ...
        assert(spTable.get(ELHISPLoopTableEntry(Pair(s0,t0),Pair(s1,t0),bruschettaRes)) == 34)
        assert(spTable.get(ELHISPLoopTableEntry(Pair(s1,t0),Pair(s0,t0),bruschettaRes)) == 34)
        assert(spTable.get(ELHISPLoopTableEntry(Pair(s0,t0),Pair(s2,t0),bruschettaRes)) == 59)
        assert(spTable.get(ELHISPLoopTableEntry(Pair(s1,t0),Pair(s2,t0),bruschettaRes)) == 25)

        assert(spTable.get(ELHISPLoopTableEntry(Pair(s0,t0),Pair(s1,t0),carbonaraRes)) == 34)
        assert(spTable.get(ELHISPLoopTableEntry(Pair(s1,t0),Pair(s0,t0),carbonaraRes)) == 34)
