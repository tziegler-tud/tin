package tin.services.ontology.loopTable.LoopTableBuilder.ruleCalculators.v2
...
class SpaS1Calculator(
     ...
     */
    fun calculateAll(table: SPALoopTable, updateTable: SPALoopTable, isInitialIteration: Boolean = true): SPALoopTable {
